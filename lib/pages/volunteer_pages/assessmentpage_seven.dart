...
class AssessmentPartSeven extends StatefulWidget {
  const AssessmentPartSeven({super.key, required this.elderid});

  final int elderid;

  @override
  State<AssessmentPartSeven> createState() => _AssessmentPartSevenState();
}

class _AssessmentPartSevenState extends State<AssessmentPartSeven> {
        ...
        ElevatedButton.icon(
          ...
          onPressed: () {
            ...
            Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) =>
                      AssessmentPartEight(elderid: widget.elderid),
                ));
          },
          style: ButtonStyle(
            backgroundColor:
