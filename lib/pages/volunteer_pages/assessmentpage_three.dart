...
class AssessmentPartThree extends StatefulWidget {
  const AssessmentPartThree({super.key, required this.elderid});

  final int elderid;

  @override
  State<AssessmentPartThree> createState() => _AssessmentPartThreeState();
}

class _AssessmentPartThreeState extends State<AssessmentPartThree> {
        ...
        ElevatedButton.icon(
          ...
          onPressed: () {
            ...
            Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) =>
                      AssessmentPartFour(elderid: widget.elderid),
                ));
          },
          style: ButtonStyle(
            backgroundColor:
