...
class AdminAssessmentPartEight extends StatefulWidget {
  const AdminAssessmentPartEight({super.key, required this.elderid});

  final int elderid;

  @override
  State<AdminAssessmentPartEight> createState() =>
      _AdminAssessmentPartEightState();
}

class _AdminAssessmentPartEightState extends State<AdminAssessmentPartEight> {
  ...
  int criterias = 6;
  final List<String> _subpart = ["8.1", "8.2", "8.3", "8.4", "8.5", "8.6"];
  List<bool> _disable8 = [];
  ...
  final Map<String, dynamic> _manageChoice8 = manageChoice8;
  final Map<String, dynamic> _enableManage8 = enableManage8;
  final List<String> _manageGroup8 = manageGroup3;
  final Map<String, dynamic> _questions8 = questions8;
  ...
  void initState() {
    super.initState();
    _disable8 = List.generate(criterias, (index) => true);
  ...
  Future<void> getAssessment() async {
    ...
    url = Uri.parse("$apiURL/riskparteight/$assId");
    ...
    if (jsonString['data'].length > 0) {
      ...
      for (var el in data) {
        setState(() {
          _manageChoice8[el['subpart']] = el['manage'];
                ...
                SizedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // try for loop
                      Column(
                        children: _questions8.entries.map((q) {
          ...
          onPressed: () {
            ...
            for (var i = 0; i < criterias; i++) {
              result.add({
                ...
                "manage": _manageChoice8[_subpart[i]],
              });
            }
    ...
    return Column(
      children: [
        ...
        CustomRadioButton(
          ...
          radioButtonValue: (value) {
            ...
            if (value == 0) {
              setState(() {
                print("$index disable");
                _disable8[index] = true;
                _answerDamage[index] = 0;
              });
            } else {
              setState(() {
                _disable8[index] = false;
              });
            }
          },
        ...
        CustomRadioButton(
          ...
          enableShape: true,
          disabledValues: _disable8[index] ? [1, 2, 3] : [],
          width: 60,
          elevation: 0,
  ...
  Widget createCheckbox1({required String sub}) {
    ...
    for (var i in List.generate(_manageGroup8.length, (index) => index)) {
      widgets.add(
        CheckboxListTile(
          // value: _manageChoice1_1[i],
          // enabled: _enable_manage1_1[i],
          value: _manageChoice8[sub][i],
          enabled: _enableManage8[sub][i],
          controlAffinity: ListTileControlAffinity.trailing,
          dense: true,
          visualDensity: VisualDensity.comfortable,
          onChanged: (value) {
            setState(() {
              _manageChoice8[sub][i] = value!;
            });
          },
          title: Text(
            _manageGroup8[i],
