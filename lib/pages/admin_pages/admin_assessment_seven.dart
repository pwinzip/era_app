...
class AdminAssessmentPartSeven extends StatefulWidget {
  const AdminAssessmentPartSeven({super.key, required this.elderid});

  final int elderid;

  @override
  State<AdminAssessmentPartSeven> createState() =>
      _AdminAssessmentPartSevenState();
}

class _AdminAssessmentPartSevenState extends State<AdminAssessmentPartSeven> {
  ...
  int criterias = 3;
  final List<String> _subpart = ["7.1", "7.2", "7.3"];
  List<bool> _disable7 = [];
  ...
  final Map<String, dynamic> _manageChoice7 = manageChoice7;
  final Map<String, dynamic> _enableManage7 = enableManage7;
  final List<String> _manageGroup7 = manageGroup3;
  final Map<String, dynamic> _questions7 = questions7;
  ...
  void initState() {
    super.initState();
    _disable7 = List.generate(criterias, (index) => true);
  ...
  Future<void> getAssessment() async {
    ...
    url = Uri.parse("$apiURL/riskpartseven/$assId");
    ...
    if (jsonString['data'].length > 0) {
      ...
      for (var el in data) {
        setState(() {
          _manageChoice7[el['subpart']] = el['manage'];
                ...
                SizedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // try for loop
                      Column(
                        children: _questions7.entries.map((q) {
          ...
          onPressed: () {
            ...
            for (var i = 0; i < criterias; i++) {
              result.add({
                ...
                "manage": _manageChoice7[_subpart[i]],
              });
            }
            ...
            Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) =>
                      AdminAssessmentPartEight(elderid: widget.elderid),
                ));
          },
          style: ButtonStyle(
            backgroundColor:
    ...
    return Column(
      children: [
        ...
        CustomRadioButton(
          ...
          radioButtonValue: (value) {
            ...
            if (value == 0) {
              setState(() {
                print("$index disable");
                _disable7[index] = true;
                _answerDamage[index] = 0;
              });
            } else {
              setState(() {
                _disable7[index] = false;
              });
            }
          },
        ...
        CustomRadioButton(
          ...
          enableShape: true,
          disabledValues: _disable7[index] ? [1, 2, 3] : [],
          width: 60,
          elevation: 0,
  ...
  Widget createCheckbox1({required String sub}) {
    ...
    for (var i in List.generate(_manageGroup7.length, (index) => index)) {
      widgets.add(
        CheckboxListTile(
          // value: _manageChoice1_1[i],
          // enabled: _enable_manage1_1[i],
          value: _manageChoice7[sub][i],
          enabled: _enableManage7[sub][i],
          controlAffinity: ListTileControlAffinity.trailing,
          dense: true,
          visualDensity: VisualDensity.comfortable,
          onChanged: (value) {
            setState(() {
              _manageChoice7[sub][i] = value!;
            });
          },
          title: Text(
            _manageGroup7[i],
